            ...
            <div class="bg-white py-24 sm:py-32">
              <div class="mx-auto max-w-7xl px-6 lg:px-8">
                ...
                <div
                  ...
                  <img class="col-span-2 max-h-14 w-full object-contain lg:col-span-1" src="images/clients-icons/logo1.png"
                  ...
                  <img class="col-span-2 max-h-14 w-full object-contain sm:col-start-2 lg:col-span-1"
                    src="images/clients-icons/logo1.png" alt="Client 4" width="158" height="48" />
                  <img class="col-span-2 col-start-2 max-h-14 w-full object-contain sm:col-start-auto lg:col-span-1"
                    src="images/clients-icons/logo1.png" alt="Client 1" width="158" height="48" />
                </div>
              </div>
            </div>
            <!-- clients section end  -->
