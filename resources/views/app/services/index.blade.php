            ...
            <div class="table-responsive">
                <table class="table table-borderless table-hover">
                    <thead>
                        <tr>
                            <th class="text-left">
                                @lang('crud.services.inputs.image1')
                            </th>
                            <th class="text-left">
                                @lang('crud.services.inputs.image2')
                            </th>
                            <th class="text-left">
                                @lang('crud.services.inputs.image3')
                            </th>
                            <th class="text-left">
                                @lang('crud.services.inputs.image4')
                            </th>
                        ...
                        <tr>
                            <td>
                                <x-partials.thumbnail
                                    src="{{ $service->image1 ? \Storage::url($service->image1) : '' }}"
                                />
                            </td>
                            <td>
                                <x-partials.thumbnail
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="5">{!! $services->render() !!}</td>
                        </tr>
                    </tfoot>
                </table>
            </div>
