                ...
                @auth
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                            ...
                            @endcan
                            @can('view-any', App\Models\Pdf::class)
                            <a class="dropdown-item" href="{{ route('pdfs.index') }}">Pdfs</a>
                            @endcan
                            ...
                            @endcan
                            @can('view-any', App\Models\System::class)
                            <a class="dropdown-item" href="{{ route('systems.index') }}">Systems</a>
                            @endcan
